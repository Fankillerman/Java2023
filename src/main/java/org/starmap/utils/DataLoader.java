...
public class DataLoader {
    ...
    public static List<Star> loadStars(String filePath) throws IOException {
    ...
    public static List<Constellation> loadConstellations(String filePath, List<Star> stars) throws IOException {
